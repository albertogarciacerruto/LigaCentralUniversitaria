...
<head>
    ...
    <title>Registrar Posiciones</title>
    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
          <div class="row">
              <div class="col-lg-12">
                  <h1 class="page-header">Nueva Posicion</h1>
              </div>
              <!-- /.col-lg-12 -->
          </div>
          <div>
              <form action="{{ url('position', $iden) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
              <div class="row">
                  <div class="col-md-12 ">
                      <div class="panel panel-default">
                          ...
                          <div class="panel-body col-12">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label for="name" class="col-md-12 control-label">Nombre de la posicion</label>

                                    <div class="col-md-12">
                                        <input id="name" type="text" maxlength="20" class="form-control" name="name" value="{{ old('name') }}" placeholder="Ingrese Nombre Posicion:" required autofocus>
                                        <br>
                                    ...
                                    <div class="col-md-12 text-center">
                                            <button class="btn btn-primary d-flex justify-content-center" type="submit">Crear Posicion</button>
                                    </div>
                                </div>
                          </div>
                      </div>
