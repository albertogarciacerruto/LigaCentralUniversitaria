...
<head>
    ...
    <title>Pagína Quienes Somos?</title>
    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
          ...
          <div>
              <form action="{{ url('nosotrosconf') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
              <div class="row">
                  <div class="col-md-12 ">
                      <div class="panel panel-default">
                          ...
                          <div class="panel-body col-12">
                                  <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                                      ...
                                      <div class="col-md-12">
                                        <textarea class="ckeditor" name="content" id="content" rows="10" cols="80" value="{{ old('content') }}">{!!$ours[0]->content!!}</textarea>
