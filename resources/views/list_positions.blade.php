...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Posiciones Registradas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="container col-lg-12">
              <div class="card card-register mx-auto mt-5">
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          <th scope="col-6" class="text-center">Nombre</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="col-6" class="text-center">{{ $position->name }}</th>
                          <td scope="col-6" class="text-center"><a class="btn btn-danger"  href="{{url('list_position', $position->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
                    {{ $list_positions->render() }}
                  </div>
              </div>
            </div>
        </div>
