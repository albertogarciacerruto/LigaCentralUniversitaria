...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Jugadores Registrados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          ...
                          <th scope="col-3" class="text-center">Apellido</th>
                          <th scope="col-3" class="text-center">Posición</th>
                          <th scope="col-3" class="text-center">Opciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach($list_jugadores as $jugador)
                        <tr>
                          <th scope="col-3" class="text-center">{{ $jugador->name }}</th>
                          <th scope="col-3" class="text-center">{{ $jugador->lastname }}</th>
                          <th scope="col-3" class="text-center">{{ $jugador->posicion }}</th>
                          <td scope="col-3" class="text-center"><a class="btn btn-danger"  href="{{url('list_jugadord', $jugador->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
                    {{ $list_jugadores->render() }}
                  </div>
              </div>
            </div>
        </div>
