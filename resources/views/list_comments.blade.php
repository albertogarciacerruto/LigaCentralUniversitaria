...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Comentarios Registrados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="container col-lg-12">
              <div class="card card-register mx-auto mt-5">
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          <th scope="col-2" class="text-center">Nombre</th>
                          <th scope="col-2" class="text-center">Correo</th>
                          <th scope="col-6" class="text-center">Comentario</th>
                          <th scope="col-2" class="text-center">Opciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach($list_comments as $comm)
                        <tr>
                          <th scope="col-2" class="text-center">{{ $comm->name }}</th>
                          <th scope="col-2" class="text-center">{{ $comm->email }}</th>
                          <th scope="col-6" class="text-center">{{ $comm->content }}</th>
                          <td scope="col-2" class="text-center"><a class="btn btn-danger"  href="{{url('list_comments_destroy', $comm->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
                    {{ $list_comments->render() }}
                  </div>
              </div>
            </div>
        </div>
