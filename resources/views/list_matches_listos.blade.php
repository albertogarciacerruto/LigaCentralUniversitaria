...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Partidos Finalizados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th scope="col-1" class="text-center">{{ $match->gol_local }}</th>
                          <th scope="col-1" class="text-center"> VS </th>
                          <th scope="col-1" class="text-center">{{ $match->gol_visita }}</th>
                          ...
                          <td scope="col-1" class="text-center"><a class="btn btn-danger"  href="{{url('list_match_ready', $match->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
