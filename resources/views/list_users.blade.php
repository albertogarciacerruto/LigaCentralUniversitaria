      ...
      <div id="page-wrapper">
            ...
            <div class="container col-lg-12">
              <div class="d-flex justify-content-end">
                <a href="{{route('register')}}"><button type="button" class="btn btn-primary">Agregar Nuevo</button></a>
              </div>
                ...
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          ...
                          <th scope="col-3" class="text-center">Tipo Acceso</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td scope="col-3" class="text-center">{{ $user->name }}</td>
                          <td scope="col-3" class="text-center">{{ $user->lastname}}</td>
                          <th scope="col-3" class="text-center">{{ $user->type}}</th>
                          <td scope="col-3" class="text-center"><a class="btn btn-danger"  href="{{url('list_users', $user->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
