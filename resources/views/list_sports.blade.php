...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Deportes Registrados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="container col-lg-12">
              <div class="d-flex justify-content-end">
                <a href="{{url('deporte')}}"><button type="button" class="btn btn-primary">Nuevo Deporte</button></a>
              </div>
              <div class="card card-register mx-auto mt-5">
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          <th scope="col-6" class="text-center">Nombre Deporte</th>
                          <th scope="col-6" class="text-center">Opciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach($list_sports as $sport)
                        <tr>
                          <th scope="col-6" class="text-center">{{ $sport->name }}</th>
                          <td scope="col-6" class="text-center"><a class="btn btn-primary"  href="{{url('position', $sport->id)}}">Agregar Posiciones</a>&nbsp<a class="btn btn-warning"  href="{{url('list_position')}}">Ver Posiciones</a>&nbsp<a class="btn btn-danger"  href="{{url('list_sport', $sport->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
