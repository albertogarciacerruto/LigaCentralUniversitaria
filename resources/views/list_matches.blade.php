...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Partidos Programados</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="container col-lg-12">
              <div class="d-flex justify-content-end">
                <a href="{{url('match')}}"><button type="button" class="btn btn-primary">Nuevo Partido</button></a>
              </div>
              <div class="card card-register mx-auto mt-5">
                <div class="panel-body">
                    ...
                    <thead>
                        <tr>
                          <th scope="col-2" class="text-center">Local</th>
                          <th scope="col-1" class="text-center"></th>
                          <th scope="col-1" class="text-center"></th>
                          <th scope="col-1" class="text-center"></th>
                          <th scope="col-2" class="text-center">Visitante</th>
                          <th scope="col-2" class="text-center">Fecha</th>
                          <th scope="col-3" class="text-center">Opciones</th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach($list_partidos as $match)
                        <tr>
                          <th scope="col-2" class="text-center">{{ $match->primero }}</th>
                          <th scope="col-1" class="text-center"><img width="25" height="25" src="../storage/app/{{ $match->imagen1 }}" alt=""></th>
                          <th scope="col-1" class="text-center"> VS </th>
                          <th scope="col-1" class="text-center"><img width="25" height="25" src="../storage/app/{{ $match->imagen2 }}" alt=""></th>
                          <th scope="col-2" class="text-center">{{ $match->segundo }}</th>
                          <th scope="col-2" class="text-center">{{ $match->fecha }}</th>
                          <td scope="col-3" class="text-center"><a class="btn btn-primary"  href="{{url('update_match', $match->id)}}">Agregar Resultado</a>&nbsp<a class="btn btn-danger"  href="{{url('list_match', $match->id)}}">Eliminar</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
